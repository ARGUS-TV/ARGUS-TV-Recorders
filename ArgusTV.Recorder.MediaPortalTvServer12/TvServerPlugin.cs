...
namespace ArgusTV.Recorder.MediaPortalTvServer
{
    public class TvServerPlugin : ITvServerPlugin
    {
        ...
        private ServiceHost _recorderTunerHost;
        ...
        public static TvResult TvController_StartRecording(ref IUser user, ref string fileName, bool contentRecording, long startTime)
        {
            lock (_tvControllerLock)
            {
                return _controller.StartRecording(ref user, ref fileName, contentRecording, startTime);
            }
        }
