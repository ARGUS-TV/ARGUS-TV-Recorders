...
namespace ArgusTV.Recorder.MediaPortalTvServer
{
    ...
    public class MediaPortalRecorderTunerService : ThreadedRecorderTunerService<RecordingThread>
    {
        ...
        public override string[] GetRecordingShares()
        {
            return GetCardFolders(true);
        }

        public override string[] GetTimeshiftShares()
        {
            return GetCardFolders(false);
        }

        private static string[] GetCardFolders(bool getRecordingFolder)
        {
            ...
            foreach (TvDatabase.Card card in cards)
            {
                ...
                {
                    string uncRecordingFolder = ArgusTV.Recorders.Common.ShareExplorer.GetUncPathForLocalPath(folder);
        ...
        public override ChannelLiveState[] GetChannelsLiveState(Channel[] channels, LiveStream liveStream)
        {
